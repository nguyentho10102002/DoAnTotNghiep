...
class OrderController extends Controller
{
    ...
    public function changeOrderStatus(Request $request)
    {
        ...
        return response(['status' => 'success', 'message' => 'Trạng thái đơn hàng được cập nhật']);
    }
    ...
    public function changePaymentStatus(Request $request)
    {
        ...
        return response(['status' => 'success', 'message' => 'Đã cập nhật trạng thái thanh toán thành công']);
    }
}
