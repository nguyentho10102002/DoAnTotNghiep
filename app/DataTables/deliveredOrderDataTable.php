        ...
        return (new EloquentDataTable($query))
            ...
            ->addColumn('payment_status', function($query){
                if($query->payment_status === 1){
                    ...
                    return "<span class='badge bg-warning'>Chưa hoàn thành</span>";
                }
            })
            ->addColumn('order_status', function($query){
                switch ($query->order_status) {
                    case 'pending':
                        return "<span class='badge bg-warning'>Chưa giải quyết</span>";
                        break;
                    case 'processed_and_ready_to_ship':
                        return "<span class='badge bg-info'>Đã xử lý</span>";
                        break;
                    case 'dropped_off':
                        return "<span class='badge bg-info'>Xóa bỏ</span>";
                        break;
                    case 'shipped':
                    ...
                    case 'delivered':
                        ...
                        break;
                    case 'canceled':
                        return "<span class='badge bg-danger'>Đã hủy đơn</span>";
                        break;
                    default:
                        # code...
                        break;
