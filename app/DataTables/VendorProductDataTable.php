    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('type', function($query){
            switch ($query->product_type) {
                ...
                case 'best_product':
                    return '<i class="badge bg-danger">Sản phẩm hàng đầu</i>';
                    break;

                default:
                    return '<i class="badge bg-dark">Không</i>';
                    break;
            }
        })
        ...
        ->addColumn('approved', function($query){
            if($query->is_approved === 1){
                return '<i class="badge bg-success">Đồng ý</i>';
            }else {
                return '<i class="badge bg-warning">Không đồng ý</i>';
            }
        })
