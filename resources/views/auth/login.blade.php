                                ...
                                <div class="wsus__login">
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="wsus__login_input">
                                            ...
                                            <input id="email" type="email" value="{{old('email')}}" name="email" placeholder="Tài khoản email">
                                        </div>
                            ...
                            <div class="tab-pane fade" id="pills-profiles" role="tabpanel"
                                ...
                                <div class="wsus__login">
                                    <form method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="wsus__login_input">
                                            <i class="fas fa-user-tie"></i>
                                            <input id="name" name="name" value="{{old('name')}}" type="text" placeholder="Tên của bạn">
                                        </div>


                                        <div class="wsus__login_input">
                                            <i class="far fa-envelope"></i>
                                            <input id="email" type="email" name="email" value="{{old('email')}}" type="text" placeholder="Tài khoản email">
                                        </div>
                                        <div class="wsus__login_input">
                                            <i class="fas fa-user-tie"></i>
                                            <select name="role" id="role" required>
                                                <option value="user" selected>Người dùng</option>
                                                <option value="vendor">Nhà phân phối</option>
                                            </select>
                                        </div>
