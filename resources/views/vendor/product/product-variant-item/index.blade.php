      ...
      <div class="row">
        <div class="col-xl-9 col-xxl-10 col-lg-9 ms-auto">
          ...
          <div class="dashboard_content mt-2 mt-md-0">
            <h3><i class="far fa-user"></i> Mục biến thể sản phẩm</h3>
            <h6>Biến thể: {{$variant->name}}</h6>
            <div class="create_button">
                <a href="{{route('vendor.products-variant-item.create', ['productId' => $product->id, 'variantId' => $variant->id])}}" class="btn btn-primary"><i class="fas fa-plus"></i> Tạo mục biến thể</a>
            </div>
