            ...
            <div class="col-xl-12">
                <div class="relative_contect d-flex">
                    ...
                    <ul class="wsus__menu_item">
                        ...
                        <li><a class="{{setActive(['vendor.index'])}}" href="{{route('vendor.index')}}">Nhà cung cấp</a></li>
                        <li><a class="{{setActive(['flash-sale'])}}" href="{{route('flash-sale')}}">Giảm giá thần tốc</a></li>
                        <li><a class="{{setActive(['blog'])}}" href="{{route('blog')}}">Bài viết</a></li>
                    ...
                    <ul class="wsus__menu_item wsus__menu_item_right">
                        ...
                        <li><a href="{{route('vendor.dashbaord')}}">Trang tổng quan nhãn hàng</a></li>
                        @elseif (auth()->user()->role === 'admin')
                        <li><a href="{{route('admin.dashbaord')}}">Trang tổng quan Admin</a></li>
            ...
            <div class="wsus__mobile_menu_main_menu">
                <div class="accordion accordion-flush" id="accordionFlushExample2">
                    <ul>
                        ...
                        <li><a href="{{route('vendor.index')}}">Nhà phân phối</a></li>
                        ...
                        <li><a href="{{route('product-traking.index')}}">Theo dõi đơn hàng</a></li>
                        <li><a href="{{route('flash-sale')}}">Giảm giá thần tốc</a></li>
                    </ul>
                </div>
            </div>
        </div>
