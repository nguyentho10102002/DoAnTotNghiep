        ...
        <div class="row justify-content-between">
            ...
            <div class="col-xl-4 col-sm-7 col-md-8 col-lg-5">
                <div class="wsus__footer_content wsus__footer_content_2">
                    ...
                    <p>Nhận tất cả các thông tin mới nhất về Sự kiện, Bán hàng và Ưu đãi.
                        Nhận tất cả các thông tin mới nhất về Sự kiện.</p>
                    ...
                    <div class="footer_payment">
                        <p>Chúng tôi đang sử dụng thanh toán an toàn cho :</p>
