                ...
                <div class="col-xl-9 col-xxl-10 col-lg-9 ms-auto">
                    <div class="dashboard_content mt-2 mt-md-0">
                        ...
                        ==============================-->
                                ...
                                <div class="">
                                    <div class="wsus__invoice_area">
                                        ...
                                        <div class="wsus__invoice_footer">
                                            ...
                                            <p><span>Tạm tính:</span> {{ @$settings->currency_icon }} {{@$order->sub_total}}</p>
                                            <p><span>Phí vận chuyển(+):</span>{{ @$settings->currency_icon }} {{@$shipping->cost}} </p>
                                            <p><span>Giảm giá từ mã coupon(-):</span>{{ @$settings->currency_icon }} {{@$coupon->discount ? $coupon->discount : 0}}</p>
                                            <p><span>Tổng cộng:</span>{{ @$settings->currency_icon }} {{@$order->amount}}</p>
                            ...
                            <!--=============================
                            TRANG HÓA ĐƠN KẾT THÚC
                        ==============================-->
                        <div class="col">
                            <div class="mt-2 float-end">
                                <button class="btn btn-warning print_invoice">In hóa đơn</button>
                            </div>
                        </div>
                        </div>
