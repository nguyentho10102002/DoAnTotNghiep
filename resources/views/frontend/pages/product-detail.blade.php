                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 col-md-7 col-lg-7">
                        <div class="wsus__pro_details_text">
                            ...
                            @if ($product->qty > 0)
                            <p class="wsus__stock_area"><span class="in_stock">Còn hàng</span> ({{$product->qty}} Sản phẩm)</p>
                            @elseif ($product->qty === 0)
                            <p class="wsus__stock_area"><span class="in_stock">Hết hàng</span> ({{$product->qty}} Sản phẩm)</p>
                            @endif
                            ...
                            <ul class="nav nav-pills mb-3" id="pills-tab3" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                                        ...
                                        aria-controls="pills-contact" aria-selected="false">Thông tin nhà phân phối</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-8 col-lg-7">
                                                    <div class="wsus__comment_area">
                                                        <h4>Danh sách đánh giá <span>{{count($reviews)}}</span></h4>
                                                ...
                                                <div class="col-xl-4 col-lg-5 mt-4 mt-lg-0">
                                                    ...
                                                    <div class="wsus__post_comment rev_mar" id="sticky_sidebar3">
                                                        ...
                                                        <form action="{{route('user.review.create')}}" enctype="multipart/form-data" method="POST">
                                                            ...
                                                            <button class="common_btn" type="submit">Gửi đánh giá
                                                                </button>
                                                        </form>
                                                    </div>
                                                    @endif
        ...
        <div class="modal-body">
          <form action="" class="message_modal">
            ...
            <div class="form-group">
              ...
              <button type="submit" class="btn add_cart mt-4 send-button">Gửi</button>
