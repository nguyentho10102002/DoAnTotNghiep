...
<section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="#">Các thành phần</a></div>
        <div class="breadcrumb-item">Hộp trò chuyện</div>
      </div>
    </div>
      ...
      <div class="row align-items-center justify-content-center">
              ...
              <ul class="list-unstyled list-unstyled-border">
                ...
                <li class="media chat-user-profile" data-id="{{ $chatUser->senderProfile->id }}">
                  ...
                  <div class="media-body">
                    ...
                    {{-- <div class="text-success text-small font-600-bold"><i class="fas fa-circle"></i> Trực tuyến</div> --}}
                  </div>
                </li>
                @endforeach
        ...
        <div class="col-md-9">
          <div class="card chat-box d-none" id="mychatbox" style="height: 70vh;">
            <div class="card-header">
              <h4 id="chat-inbox-title">Trò chuyện với Rizal</h4>
            </div>
            ...
            <div class="card-footer chat-form">
              <form id="message-form">
                <input type="text" class="form-control message-box" placeholder="Gõ tin nhắn" name="message">
            ...
            $('.chat-user-profile').on('click', function(){
                ...
                $.ajax({
                    ...
                    beforeSend: function() {
                        ...
                        $('#chat-inbox-title').text(`Trò chuyện với ${chatUserName}`)
                    },
